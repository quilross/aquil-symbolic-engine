...
const BASE_URL = process.env.API_BASE_URL || 'https://signal_q.catnip-pieces1.workers.dev';
const USER_TOKEN = process.env.API_TOKEN || 'sq_live_test_token_placeholder';
const ADMIN_TOKEN = process.env.API_TOKEN_ADMIN || 'sq_admin_test_token_placeholder';
