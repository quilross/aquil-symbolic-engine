...
const BASE_URL = process.env.BASE_URL || 'https://signal_q.catnip-pieces1.workers.dev';
const USER_TOKEN = process.env.API_TOKEN_USER || 'sq_live_7k9m2n8p4x6w1z5q3r7t9v2b4c6d8f0h';
const ADMIN_TOKEN = process.env.API_TOKEN_ADMIN || 'sq_admin_9x7c5v1b3n6m8k2q4w7e9r5t3y8u1o6p2';
