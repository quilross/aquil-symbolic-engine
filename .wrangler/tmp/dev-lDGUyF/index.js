    ...
    async fetch(e3, ...o3) {
      ...
      for (let [a2, c2, i2, l2] of t)
        if ((a2 == e3.method || "ALL" == a2) && (r = n.pathname.match(c2))) {
          ...
          for (let t2 of i2)
            if (null != (s2 = await t2(e3.proxy ?? e3, ...o3))) return s2;
        }
    },
  }),
  "e",
...
var o = /* @__PURE__ */ __name(
  (e2 = "text/plain; charset=utf-8", t) =>
    (o2, { headers: s2 = {}, ...r } = {}) =>
      void 0 === o2 || "Response" === o2?.constructor.name
        ? o2
        : new Response(t ? t(o2) : o2, {
            headers: {
              "content-type": e2,
              ...(s2.entries ? Object.fromEntries(s2) : s2),
            },
            ...r,
          }),
  "o",
  ...
  try {
    ...
    const result = {
      ...
      trust_analysis: {
        ...
        body_wisdom: body_sensations
          ? `Your body is communicating through: ${body_sensations}. Let's honor what it's telling you.`
          : "Notice what your body is communicating right now.",
        situation_guidance: specific_situation
          ? `Regarding "${specific_situation}": This situation is perfect for practicing trust in real-world application.`
          : "Each situation is an opportunity to practice trusting your inner knowing.",
      },
      personalized_guidance: {
        main_message: generateMainMessage(
          analysis.trust_level,
          analysis.readiness_level,
        ),
        trust_level_insight: getTrustLevelInsight(analysis.trust_level),
        ...
        internal_authority_guidance:
          generateInternalAuthorityGuidance(analysis),
      },
      trust_exercises: generateTrustExercises(analysis),
      patterns_identified: {
        current_patterns:
          analysis.trust_blocks.length > 0
            ? `Working with ${analysis.trust_blocks[0]} is your current growth edge`
            : "Building foundation patterns for trust development",
        growth_trajectory:
          analysis.trust_level >= 7
            ? "Strong trust foundation"
            : "Developing trust capacity",
    ...
    const result = {
      ...
      integration_practices: [
        ...
        },
        {
          ...
          instruction:
            "Notice what emotions or memories this content brings up - they contain information for healing.",
          purpose: "Use media as emotional intelligence development",
        },
        {
          name: "Trust Connection Practice",
          instruction:
            "Ask yourself: How does this content relate to my journey of trusting myself more?",
          purpose: "Connect entertainment to trust-building work",
        },
      ],
      trust_connection:
        "Trust your attraction to certain content - your unconscious mind is sophisticated and knows what you need for growth.",
    ...
    const result = {
      ...
      body_wisdom: {
        ...
        somatic_intelligence:
          "Your body processes information faster and more accurately than analytical thinking - it never lies.",
      },
      somatic_session: {
      ...
      trust_integration: {
        body_trust_connection:
          "Your body never lies - it always tells you the truth about your current state and what you need.",
        decision_making:
          "Physical sensations are direct access to your intuitive guidance system - expansion means yes, contraction means no.",
        emotional_intelligence:
          "Your emotions live in your body first - befriending your body befriends your emotional wisdom.",
        internal_authority:
          "Trusting your body helps you trust yourself in all areas of life - it's foundational to internal authority.",
      },
      standing_tall_connection:
        "Your relationship with your body directly affects your ability to stand tall in the world. Every moment you listen to your body with respect builds internal trust and authentic presence.",
      healing_insights: generateSomaticInsights(body_state, emotions),
      body_affirmation:
        "My body is wise, intelligent, and constantly supporting my highest good",
      integration_guidance: {
        daily_practice:
          "Check in with your body 3 times today - morning, midday, evening - and thank it for its communication.",
        decision_support:
          "Before your next important decision, place hand on belly and notice: does this option create expansion or contraction?",
        trust_building:
          "Each time you listen to and honor your body, you build deeper self-trust and standing tall capacity.",
      },
      next_session_guidance:
        "Continue this practice daily. Notice how your relationship with your body and trust in yourself evolves over time.",
    };
    return addCORSHeaders(
      new Response(JSON.stringify(result), {
        headers: { "Content-Type": "application/json" },
    ...
    const result = {
      ...
      situation_analysis: {
        ...
        integration_approach:
          "Synthesizing multiple wisdom streams into coherent, actionable guidance",
      },
      framework_insights: {
        human_design: {
          strategy:
          ...
          type_guidance:
            "Your unique energetic design supports specific decision-making approaches - honor your natural way",
          integration:
            "Follow your strategy and authority consistently to build evidence of your inner wisdom",
        },
        gene_keys: {
          gift_activation:
            "Practice acceptance of what is while maintaining vision for growth - this creates space for authentic transformation",
          shadow_work:
            "Notice where you might be rejecting your current circumstances or capabilities - shadows contain hidden gifts",
          siddhi_potential:
            "Your highest potential emerges through integrating and transcending current challenges",
          evolutionary_pressure:
            "Current challenges are evolutionary pressure supporting your next level of consciousness",
        },
        astrology: {
          timing:
            "Cosmic energies are supporting inner work and building trust-based foundations right now",
          energy_dynamics:
            "Current planetary alignments favor authentic choices based on inner authority rather than external expectations",
          soul_purpose:
            "Your natal chart reveals unique gifts that want expression through trusting your authentic nature",
          cycles:
            "You're in a supportive cycle for making authentic choices that align with your deepest values",
        },
        somatic_wisdom: {
          embodiment:
            "Your body processes information faster and more accurately than analytical thinking",
          decision_framework:
            "Present options to your body and notice expansion (yes) or contraction (no) responses",
          trauma_integration:
            "Past experiences stored in your body inform but don't need to control current decisions",
          nervous_system:
            "A regulated nervous system supports clear access to intuitive guidance",
        },
      },
      synthesized_wisdom: {
      ...
      trust_applications: {
        primary_lesson:
          "Your unique design specifically supports trusting yourself - you're not broken, you're learning to operate according to your authentic nature",
        evidence_building:
          "Each time you follow integrated inner guidance and see positive results, you build unshakeable self-trust",
        integration:
          "Trust builds through consistently honoring wisdom from all your internal systems - body, intuition, timing, acceptance",
      },
      standing_tall_guidance: {
        foundation:
          "Standing tall is the natural result of trusting your integrated inner authority rather than external validation",
        practice:
          "Each time you honor your multi-dimensional inner guidance, you practice standing in your authentic power",
        embodiment:
          "Authentic presence emerges when you trust the wisdom of your whole system - body, mind, spirit, timing",
      },
...
router.post("/api/patterns/recognize", async (request) => {
  try {
    ...
    const result = {
      ...
      timestamp: /* @__PURE__ */ new Date().toISOString(),
      message:
        "Your willingness to look for patterns shows sophisticated consciousness and commitment to growth. Pattern awareness creates choice and conscious evolution.",
      pattern_analysis: {
        focus_area: area_of_focus,
        recent_patterns: recent_experiences,
        recurring_elements:
          recurring_themes || "New patterns emerging through awareness",
        meta_pattern:
          "Your pattern recognition seeking itself shows developing meta-awareness and conscious growth direction",
      },
      identified_patterns: [
        {
          ...
          significance:
            "Shows developing meta-awareness and commitment to conscious evolution",
        },
        {
          type: "trust_evolution",
          pattern:
            "Every interaction with self-development work builds evidence of your capacity for self-guided growth",
          evolution:
            "Progressing from external validation seeking toward internal authority development",
          growth_trajectory:
            "Consistent engagement indicates building trust in your own growth process",
        },
        {
          type: "standing_tall_development",
          pattern:
            "Each time you engage in self-reflection, you practice standing in your truth and taking up space for your growth",
          embodiment:
            "Pattern recognition itself requires standing tall in your commitment to growth",
          authentic_presence:
            "Willingness to examine patterns shows courage and authentic self-engagement",
        },
      ],
      pattern_insights: {
        meta_patterns: [
      ...
      growth_recommendations: [
        {
          ...
          recommendation:
            "Keep noticing patterns in daily life - this awareness creates choice and conscious evolution",
          practice:
            "Weekly pattern check-ins: What patterns am I noticing in my thoughts, reactions, and choices?",
          priority: "ongoing",
        },
        {
          area: "Pattern Integration",
          recommendation:
            "Work with patterns through acceptance rather than resistance - they contain gifts",
          practice:
            "Ask: What is this pattern trying to teach me or protect me from?",
          priority: "high",
        },
        {
          area: "Conscious Response Development",
          recommendation:
            "Use pattern awareness to create new response choices in familiar situations",
          practice:
            "When you notice a pattern arising, pause and ask: How could I respond differently this time?",
          priority: "medium",
        },
      ],
      celebration_moments: [
      ...
      pattern_evolution_tracking: {
        ...
        integration_capacity:
          "Developing - building skills to work with patterns consciously",
        choice_expansion:
          "Your pattern awareness is expanding your range of conscious responses to life",
        trust_building:
          "Seeing your own patterns builds evidence that you can understand and guide your own growth",
      },
      standing_tall_connection:
        "Pattern recognition requires standing tall in your truth and commitment to growth. Each time you examine patterns honestly, you practice authentic self-engagement.",
      next_level_guidance:
        "Patterns reveal themselves when you're ready to evolve beyond them. Trust this process and your capacity to grow consciously.",
    };
    return addCORSHeaders(
      new Response(JSON.stringify(result), {
        headers: { "Content-Type": "application/json" },
...
router.post("/api/standing-tall/practice", async (request) => {
  try {
    ...
    const result = {
      ...
      timestamp: /* @__PURE__ */ new Date().toISOString(),
      message:
        "Your desire to stand tall instead of shrinking is a powerful choice. You don't need to earn the right to take up space - it's already yours by virtue of being human.",
      situation_analysis: {
        challenge: situation,
        growth_edge:
          fears_concerns ||
          "Moving beyond comfort zone and into authentic presence",
        vision: desired_outcome,
        strengths:
          past_successes ||
          "Your courage to address this situation shows existing inner strength",
        pattern_recognition: analyzeShrinkingPatterns(
          situation,
          fears_concerns,
        ),
      },
      ...
      empowerment_practices: [
        {
          ...
          instruction:
            "Throughout the day, reset your posture: feet grounded, spine long, chest open, shoulders relaxed. Breathe deeply in this position.",
        ...
        },
        {
          ...
          instruction:
            'Before challenging interactions, place hand on heart and say: "I trust myself to handle this situation with integrity and presence."',
          purpose:
            "Connect with inner wisdom and strength before standing tall moments",
          frequency: "Before challenging situations",
        },
        {
          name: "Fear Transformation Practice",
          instruction:
            'When fear of standing tall arises, breathe into it and ask: "How is this fear trying to protect me? What does it need from me?"',
        ...
        },
        {
          ...
          instruction:
            "Practice sharing one authentic thought or feeling daily, starting small and building to bigger truths.",
      ...
      confidence_building: {
        ...
        strength_activation: identifyStandingTallStrengths(
          situation,
          desired_outcome,
        ),
      },
      trust_integration: {
        foundation:
          "Standing tall is the external expression of internal self-trust - they develop together and support each other",
        practice:
          "You cannot authentically stand tall without trusting your inner authority and inherent worth",
        development:
          "Each time you practice standing tall, you build evidence that you can trust yourself in challenging situations",
        embodiment:
          "Standing tall becomes natural when you trust that your authentic self is worthy of space and voice",
      },
      ...
      daily_practices: [
        {
          ...
          instruction:
            "Spend 2 minutes each morning in confident posture while setting intention to stand tall throughout the day",
          benefit: "Programs your nervous system for confidence and presence",
        },
        {
          name: "Courage Micro-Moments",
          instruction:
            "Take one small action each day that requires you to be slightly more visible or authentic than usual",
          benefit: "Gradually expands your comfort zone with standing tall",
        },
        {
          name: "Evening Acknowledgment",
          instruction:
            "Each evening, acknowledge one moment when you stood tall or one opportunity to do so tomorrow",
          benefit:
            "Builds awareness and celebrates progress in standing tall development",
        },
      ],
      integration_guidance:
        "Standing tall is a practice, not a destination. Each time you choose presence over shrinking, you strengthen this capacity. Be patient and compassionate with yourself as you develop this skill.",
      next_steps: generateStandingTallNextSteps(
        situation,
        desired_outcome,
        fears_concerns,
      ),
    ...
    return addCORSHeaders(
      new Response(
        JSON.stringify({
          ...
          message:
            "Your inherent dignity and worth are never in question. Stand tall because you belong here, exactly as you are.",
        }),
        {
          status: 500,
          headers: { "Content-Type": "application/json" },
...
router.get("/api/wisdom/daily-synthesis", async (request) => {
  try {
    ...
    const result = {
      ...
      message:
        "Your wisdom journey with Aquil is developing beautifully - you're building sophisticated inner authority and the capacity to stand tall in your authentic power.",
      daily_message: {
        intention:
          "Today is an opportunity to deepen your trust in yourself and practice standing taller in your authentic power.",
        focus:
          "Notice moments throughout the day when you can choose trust over fear, expansion over contraction, authentic presence over shrinking.",
        practice:
          "Check in with your body regularly and honor what it's communicating - this builds the somatic foundation for trust and standing tall.",
        affirmation:
          "I am becoming more rooted in self-trust and authentic presence every day.",
      },
      trust_evolution: {
        current_phase:
          "Active development - building integration between inner authority and outer expression",
        trend:
          "Growing integration of body wisdom, emotional intelligence, and conscious choice-making",
        message:
          "Every interaction with your inner development work builds evidence of your capacity for self-guided growth and authentic presence",
        development_focus:
          "Integration of trust-building with standing tall practice for authentic empowerment",
      },
      framework_integration: {
        human_design:
          "Learning to trust your gut responses and unique energetic design as primary guidance",
        gene_keys:
          "Practicing acceptance of current reality as foundation for authentic transformation and gift emergence",
        astrology:
          "Aligning with cosmic timing and energy for inner authority and authentic expression development",
        somatic_wisdom:
          "Building body-based decision making capacity and nervous system regulation for presence",
      },
      wisdom_themes: [
      ...
      daily_practices: [
        {
          time: "Morning",
          practice:
            "Set intention to trust yourself and stand tall in authenticity throughout the day",
          purpose: "Program nervous system for confidence and inner authority",
        },
        {
          time: "Midday",
          practice:
            "Check in with your body and emotions - what is your inner wisdom communicating?",
          purpose: "Strengthen somatic awareness and trust in body wisdom",
        },
        {
          time: "Evening",
          practice:
            "Celebrate moments when you trusted yourself or stood tall, identify tomorrow's opportunities",
          purpose:
            "Build evidence of growth and plan for continued development",
        },
      ],
      growth_insights: {
        pattern_recognition:
          "Your consistent engagement with inner development shows sophisticated consciousness and commitment to growth",
        trust_building:
          "Each interaction builds your capacity to trust your own wisdom and stand in your authentic power",
        standing_tall_development:
          "Authentic presence emerges naturally as you build trust in your inherent worth and inner authority",
        integration:
          "You're developing the ability to synthesize wisdom from multiple sources into coherent, embodied action",
      },
      personalized_guidance: generatePersonalizedDailyGuidance(period),
      celebration:
        "You're consistently choosing growth, self-understanding, and authentic development - this creates compound effects over time and builds unshakeable inner foundation.",
      growth_reminder:
        "You are exactly where you need to be in your journey of building unshakeable inner trust and authentic presence. Every step counts, every awareness matters, every choice for growth strengthens your foundation.",
    };
    return addCORSHeaders(
      new Response(JSON.stringify(result), {
        headers: { "Content-Type": "application/json" },
    ...
    return addCORSHeaders(
      new Response(
        JSON.stringify({
          ...
          message:
            "Your wisdom journey continues even when systems are offline. Trust your inner knowing and keep practicing standing tall in your truth.",
        }),
        {
          status: 500,
          headers: { "Content-Type": "application/json" },
...
async function logEvent(env, event) {
  ...
  const tagsCsv = Array.isArray(event.tags)
    ? event.tags.join(",")
    : event.tags || null;
...
async function getEvents(env, opts = {}) {
  const { limit, type, who, level, session_id, tag, since, until, idx1, idx2 } =
    opts;
  ...
  `;
  params.push(lim);
  const { results } = await env.AQUIL_DB.prepare(sql)
    .bind(...params)
    .all();
  return results || [];
}
    ...
    return router.handle(request, env, ctx).catch((err) => {
      ...
      return new Response(
        JSON.stringify({
          ...
          timestamp: /* @__PURE__ */ new Date().toISOString(),
          support:
            "Your personal AI system is sophisticated and resilient - temporary errors don't affect your growth journey",
        }),
        {
          status: 500,
          headers: corsHeaders,
...
function analyzeTrustLevel(text) {
  ...
  if (
    ["confident", "sure", "trust", "know"].some((word) =>
      lowerText.includes(word),
    )
  )
    return 7;
  if (
    ["uncertain", "unsure", "doubt", "confused"].some((word) =>
      lowerText.includes(word),
    )
  )
    return 4;
...
function assessReadinessLevel(text) {
  const lowerText = text.toLowerCase();
  if (
    ["ready", "excited", "motivated", "committed", "willing"].some((word) =>
      lowerText.includes(word),
    )
  )
    return "high";
  if (
    ["overwhelmed", "tired", "stuck", "resistant", "scared"].some((word) =>
      lowerText.includes(word),
    )
  )
    return "low";
...
function assessInternalVsExternal(text) {
  ...
  const internalScore = internalCues.filter((cue) =>
    lowerText.includes(cue),
  ).length;
  const externalScore = externalCues.filter((cue) =>
    lowerText.includes(cue),
  ).length;
  ...
  trustBlocks.forEach((block) => {
    switch (block) {
      case "external_validation":
        guidance[block] = {
          insight:
            "Looking outside for validation is a learned pattern, not a character flaw.",
          practice:
            "Before seeking others' opinions, pause and ask: 'What do I think about this?'",
          reframe:
            "Others' opinions are data points, not the final authority on your choices.",
        };
        break;
      case "perfectionism":
        guidance[block] = {
          insight:
            "Perfectionism often masks fear of judgment or failure - it's a protection strategy.",
          practice:
            "Practice 'good enough' - take action with 80% certainty rather than waiting for 100%.",
...
function generateTrustExercises(analysis) {
  ...
  exercises.push({
    ...
    instruction:
      'Three times today, pause and ask: "How much do I trust myself right now?" Just notice without judgment.',
  ...
  if (analysis.trust_level <= 4) {
    exercises.push({
      ...
      instruction:
        "Make one tiny decision today purely from your gut feeling - like which route to take.",
...
function identifyCurrentStrengths(analysis) {
  ...
  strengths.push(
    "You have the courage to examine your trust patterns - this shows emotional intelligence",
  );
  return strengths;
}
...
function generateInternalAuthorityGuidance(analysis) {
  return {
    current_level:
      analysis.internal_vs_external === "internal_focused"
        ? "Advanced - primarily referencing inner knowing"
        : "Developing - building internal reference points",
    development_practices: [
      "Practice making small decisions without consulting others",
    ],
    integration_steps: [
      "Start with trusting yourself in areas where you already have good judgment",
    ],
  };
}
...
function identifyCelebrationMoments(analysis) {
  ...
  if (analysis.trust_level >= 7) {
    celebrations.push(
      "\u{1F389} Your trust level is genuinely high - this is real progress worth celebrating!",
    );
  }
  if (analysis.readiness_level === "high") {
    celebrations.push(
      "\u2728 Your readiness for growth shows beautiful self-compassion and courage",
    );
  }
  celebrations.push(
    "\u{1F331} You chose to do this trust check-in - this decision shows self-care and growth commitment",
  );
...
function generateGrowthInsights(analysis) {
  ...
  if (analysis.trust_blocks.length > 0) {
    insights.push(
      `Working with ${analysis.trust_blocks[0]} is your current growth edge - it's showing you where trust wants to expand`,
    );
  }
  insights.push(
    "Every trust check-in strengthens your internal authority and builds evidence of your self-guidance capacity",
  );
  return insights;
}
...
function generateNextSteps(analysis) {
  const steps = [];
  steps.push(
    "Acknowledge yourself for doing this trust check-in - this itself is an act of self-care",
  );
  if (analysis.trust_level >= 7) {
    steps.push(
      "Choose one area where you could trust yourself more and take one small action there today",
    );
  } else {
...
function identifyArchetypalThemes(reaction) {
  ...
  const themes = [];
  if (
    ["hero", "journey", "adventure", "overcome"].some((word) =>
      lowerReaction.includes(word),
    )
  ) {
    themes.push("Hero's Journey - transformation through challenge");
  }
  if (
    ["love", "relationship", "connection"].some((word) =>
      lowerReaction.includes(word),
    )
  ) {
  ...
  if (
    ["power", "control", "authority"].some((word) =>
      lowerReaction.includes(word),
    )
  ) {
  ...
  return themes.length > 0
    ? themes
    : ["Personal Integration - unique wisdom for your journey"];
}
...
function generateSomaticInsights(bodyState, emotions) {
  return {
    ...
    integration_opportunity:
      "This combination of sensations and emotions contains valuable information for your trust and standing tall development",
    wisdom_access:
      "Your body is giving you direct access to wisdom that your analytical mind might miss",
  };
}
...
function analyzeShrinkingPatterns(situation, fears) {
  return {
    pattern_type:
      "Common shrinking pattern in challenging interpersonal situations",
    growth_opportunity:
      "Each time you practice standing tall here, you expand your overall confidence capacity",
  };
}
...
function generateFearReframes(fears) {
  if (!fears)
    return [
      "Fear often indicates you care deeply about the outcome - this caring is actually beautiful",
    ];
  return [
...
function generatePersonalizedDailyGuidance(period) {
  return {
    focus_area:
      "Integration of trust-building with authentic presence development",
    key_practice:
      "Use your body as a guidance system for both trust and standing tall decisions",
    growth_edge:
      "Each conscious choice builds evidence of your capacity for self-directed growth",
  };
}
