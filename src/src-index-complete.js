...
router.post('/api/somatic/session', async (request, env) => {
  try {
    ...
    const result = {
      ...
      body_analysis: {
        message: "Your willingness to connect with your body shows beautiful self-awareness",
    ...
    const result = {
      ...
      framework_insights: {
        ...
        gene_keys: {
          ...
          shadow_work: "Notice where you might be rejecting your current circumstances or capabilities"
        },
        astrology: {
          timing: "This is a supported time for making authentic choices based on inner authority",
          energy: "Strong cosmic support for inner work and building trust-based foundations"
        },
        somatic_wisdom: {
          embodiment: "Your body processes information faster and more accurately than analytical thinking",
          practice: "Before decisions, scan your body for expansion (yes) or contraction (no)"
        }
      },
      synthesized_wisdom: {
      ...
      trust_applications: {
        primary_lesson: "Your design specifically supports trusting yourself - you're not broken, you're learning to operate correctly",
        integration: "Trust builds through consistently honoring the wisdom from all your internal systems"
      },
  ...
  try {
    ...
    const result = {
      ...
      identified_patterns: [
        {
          type: 'self_awareness',
          description: 'Pattern recognition seeking shows developing meta-awareness and conscious growth direction',
      ...
      pattern_insights: {
        ...
        growth_acceleration: ['Pattern awareness creates choice and conscious evolution']
      },
  ...
  try {
    ...
    const result = {
      ...
      situation_analysis: {
        ...
        growth_opportunity: "This situation is perfect for practicing authentic presence and confidence"
      },
        ...
        daily_practices: [
          {
            ...
            instruction: "Spend 2 minutes in confident posture while setting intention to stand tall today"
          },
          {
            name: "Courage Micro-Moments", 
            instruction: "Take one small action today requiring you to be slightly more visible or authentic"
          }
        ]
      },
      trust_integration: {
        connection: "Standing tall is the external expression of internal self-trust - they develop together",
        practice: "You can't authentically stand tall if you don't trust your inner authority"
      }
    };
  ...
  try {
    ...
    const result = {
      ...
      framework_integration: {
        human_design: "Learning to trust your gut responses as primary guidance",
        gene_keys: "Practicing acceptance as foundation for authentic transformation", 
      ...
      daily_focus: "Notice how your different wisdom systems are speaking to you and practice trusting their integration",
      celebration: "You're consistently choosing growth and self-understanding - this creates compound effects over time"
    };
